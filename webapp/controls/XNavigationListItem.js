...
sap.ui.define(["jquery.sap.global", "sap/ui/core/Item",
	...
	function(jQuery, Item, Icon, NavigationList, Renderer, IconPool, NavigationListItem, MessageToast) {
		...
		var XNavigationListItem = NavigationListItem.extend("com.sap.build.standard.scopeCopy.controls.XNavigationListItem", /** @lends sap.tnt.NavigationListItem.prototype */ {
			metadata: {
				defaultAggregation: "xitems",
				aggregations: {
					xitems: {
						type: "com.sap.build.standard.scopeCopy.controls.XNavigationListItem",
						multiple: true,
						singularName: "item"
					}
				}
			...
			getLevel: function() {
				...
				while (parent && parent.getMetadata().getName() == 'com.sap.build.standard.scopeCopy.controls.XNavigationListItem') {
					level = level + 1;
